...
const projects = [
  ...
  },
  {
    ...
    cardImage: "assets/images/project-page/HSFSIframework.png",
...
const showCards = () => {
  let output = "";
  projects.forEach(({ title, cardImage, Previewlink, description, Githublink }) => {
    output += `       
        <div class="column skill-card card" style="margin: 15px"data-aos="zoom-in-up" data-aos-easing="linear" data-aos-delay="300" data-aos-duration="600" >
          <div class="wrapper">
  <img src="${cardImage}" class="project-image" />
